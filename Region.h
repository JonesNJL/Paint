...
class Region
{
	public:
		...
		GuiElement* backgroundTopLeft;
		GuiElement* backgroundTopRight;
		GuiElement* backgroundBottomLeft;
		GuiElement* backgroundBottomRight;
		GuiElement* backgroundLeft;
		GuiElement* backgroundRight;
		GuiElement* backgroundTop;
		GuiElement* backgroundBottom;
		GuiElement* backgroundCenter;
